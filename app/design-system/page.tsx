...
import { Plus, Music, Trash2, Edit2, Play, Pause, AlertCircle, MoreVertical, Info, X, Tag, ChevronDown, SlidersHorizontal, ChevronUp, Search, Settings, Folder, FileAudio, Volume2, SkipBack, SkipForward, Sparkles } from 'lucide-react'
...
export default function DesignSystemPage() {
  ...
  const CodeBlock = ({ code, id }: { code: string; id: string }) => (
    <div className="relative group">
      <pre className="bg-black/40 border border-white/10 rounded-[8px] p-4 overflow-x-auto text-[13px] text-white/90 font-mono scrollbar-custom">
        <code>{code}</code>
      </pre>
      <button
        onClick={() => copyCode(code, id)}
        className="absolute top-2 right-2 px-3 py-1.5 bg-white/10 hover:bg-white/20 rounded-[6px] text-[12px] text-white/70 hover:text-white transition-colors"
      >
  ...
  const ColorSwatch = ({ color, name, description }: { color: string; name: string; description: string }) => (
    <div>
      ...
      <p className="text-[13px] text-white/90 font-mono">{name}</p>
    ...
    <div className="min-h-screen bg-[#111111]">
      ...
      <div className="border-b border-white/10 bg-gradient-to-b from-purple-500/5 via-transparent to-transparent">
        <div className="max-w-7xl mx-auto px-8 py-16">
          ...
          <p className="text-[18px] text-white/60 max-w-3xl">
        ...
        <nav className="w-64 flex-shrink-0">
          <div className="sticky top-8">
            <div className="bg-[#191919] border border-white/10 rounded-[8px] p-4">
              <h3 className="text-[14px] font-semibold text-white mb-3">Navigation</h3>
                        ...
                        {section.subsections.map((sub) => (
                          <li key={sub.id}>
                            <a
                              ...
                              className={`block px-2 py-1 rounded-[4px] text-[12px] transition-colors ${
          ...
          <Section title="Overview" id="overview">
            <div className="prose prose-invert max-w-none">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                <div className="bg-black/20 rounded-[8px] p-4 border border-white/5">
                  <div className="text-[32px] font-bold text-white mb-1">50+</div>
                  <div className="text-[13px] text-white/60">Components</div>
                </div>
                <div className="bg-black/20 rounded-[8px] p-4 border border-white/5">
                  <div className="text-[32px] font-bold text-white mb-1">15+</div>
                  <div className="text-[13px] text-white/60">Patterns</div>
                </div>
                <div className="bg-black/20 rounded-[8px] p-4 border border-white/5">
                  <div className="text-[32px] font-bold text-white mb-1">100%</div>
                  <div className="text-[13px] text-white/60">Accessible</div>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="Foundation" id="foundation">
            <div className="space-y-12">
              ...
              <div id="colors" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Colors</h3>
                
                <div className="mb-6">
                  <h4 className="text-[14px] font-medium text-white/80 mb-3">Background Colors</h4>
                ...
                <div className="mb-6">
                  <h4 className="text-[14px] font-medium text-white/80 mb-3">Text Colors</h4>
                  <div className="space-y-2 bg-black/20 rounded-[8px] p-4">
                    <div className="flex items-center justify-between">
                      <span className="text-white">Primary Text</span>
                      <code className="text-[13px] text-white/60 font-mono">text-white</code>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-white/60">Secondary Text</span>
                      <code className="text-[13px] text-white/60 font-mono">text-white/60</code>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-white/40">Tertiary Text</span>
                      <code className="text-[13px] text-white/60 font-mono">text-white/40</code>
                    </div>
                  </div>
                </div>

                <div className="mb-6">
                  <h4 className="text-[14px] font-medium text-white/80 mb-3">Accent Colors</h4>
              ...
              <div id="typography" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Typography</h3>
                ...
                <div className="space-y-4 bg-[#191919] border border-white/10 rounded-[8px] p-6">
                  <div>
                    ...
                    <p className="text-[13px] text-white/60 font-mono">text-[20px] - Page titles</p>
                  </div>
                  <div>
                    <p className="text-[16px] text-white mb-1">Heading (16px)</p>
                    <p className="text-[13px] text-white/60 font-mono">text-[16px] - Section headers</p>
                  </div>
                  <div>
                    <p className="text-[14px] text-white mb-1">Body (14px)</p>
                    <p className="text-[13px] text-white/60 font-mono">text-[14px] - Default text</p>
                  </div>
                  <div>
                    <p className="text-[13px] text-white mb-1">Small (13px)</p>
                    <p className="text-[13px] text-white/60 font-mono">text-[13px] - Secondary text</p>
                  </div>
                  <div>
                    <p className="text-[12px] text-white mb-1">Tiny (12px)</p>
                    <p className="text-[13px] text-white/60 font-mono">text-[12px] - Labels, captions</p>
                  </div>
                </div>
              </div>
              ...
              <div id="spacing" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Spacing</h3>
                <p className="text-[14px] text-white/60 mb-4">8px base grid system</p>
                ...
                <div className="space-y-3 bg-[#191919] border border-white/10 rounded-[8px] p-6">
                  {[
                    ...
                    <div key={size} className="flex items-center gap-4">
                      ...
                      <code className="text-[13px] text-white/60 font-mono w-16">{className}</code>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <Section title="Components" id="components">
            <div className="space-y-12">
              ...
              <div id="buttons" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Buttons</h3>
...
<button className="w-10 h-10 rounded-[8px] hover:bg-white/5 flex items-center justify-center transition-colors">
  <Play className="w-[18px] h-[18px] text-white/70" />
              ...
              <div id="modals" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Modals</h3>
...
/>`}
              ...
              <div id="inputs" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Inputs</h3>
              ...
              <div id="cards" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Cards</h3>
                ...
                <Example title="Standard Card">
                  <div className="bg-[#191919] rounded-[8px] p-4 border border-white/10">
                    ...
                    <p className="text-[13px] text-white/60">Card content goes here. Cards are used for grouping related content.</p>
                  </div>
                </Example>
                  ...
                  <div className="bg-[#191919] rounded-[8px] p-4 border border-white/10 hover:bg-white/5 cursor-pointer transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[13px] text-white/60">Hover to see the subtle background change</p>
                      </div>
                    </div>
                  </div>
                </Example>
              ...
              <div id="empty-states" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Empty States</h3>
          ...
          <Section title="Patterns" id="patterns">
            <div className="space-y-12">
              ...
              <div id="tables" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Tables</h3>
                  ...
                  <div className="flex flex-col">
                    ...
                    {sortedTableData.map((item) => (
                      ...
                      >
                        ...
                        <div className="w-24 text-[13px] text-white/60 text-right">{item.duration}</div>
                        <div className="w-32 text-[13px] text-white/60">{item.type}</div>
                        <div className="w-12"></div>
                      </div>
                    ))}
              ...
              <div id="sidebars" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Sidebars</h3>
                      ...
                      <div className="flex-1 overflow-y-auto scrollbar-custom px-6 py-4">
                        <ul role="list" className="space-y-2">
                          {['All Files', 'Battle Music', 'Tavern Ambience', 'Forest Sounds', 'Epic Themes'].map((item, i) => (
                            <li key={i}>
                              <button className={`w-full flex items-center gap-2 px-3 py-2 rounded-[8px] text-[13px] font-medium transition-colors ${i === 0 ? 'bg-white/10 text-white' : 'text-white/70 hover:text-white hover:bg-white/5'}`}>
                                <Music className="w-4 h-4 flex-shrink-0" />
                                <span className="flex-1 truncate text-left">{item}</span>
                                <span className="text-[11px] text-white/50">{Math.floor(Math.random() * 20)}</span>
                              </button>
                            </li>
                          ))}
                        </ul>
              ...
              <div id="context-menus" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Context Menus</h3>
                
                <Example title="Right-Click Menu" description="Try right-clicking on the table rows above">
                  <div className="p-12 bg-black/20 rounded-[8px] flex items-center justify-center">
                    <p className="text-[14px] text-white/60 text-center">
                      Right-click on table rows above to see the context menu in action
                    </p>
                  </div>
                </Example>
              </div>
              ...
              <div id="dropdowns" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Dropdowns</h3>
                  ...
                  <div className="flex justify-center p-8">
                    <div className="relative" ref={dropdownRef}>
                      <button
                        ...
                        className="px-3 py-1.5 text-[13px] text-white/70 hover:text-white hover:bg-white/5 rounded-[6px] transition-colors flex items-center gap-1.5 border border-white/10"
                      >
              ...
              <div id="tags" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Tags</h3>
              ...
              <div id="inline-editing" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Inline Editing</h3>
                        ...
                        <div className="flex-1">
                          {editingId === item.id ? (
                            ...
                            <div
                              ...
                              className="py-1 text-[14px] text-white truncate cursor-pointer hover:text-purple-300 transition-colors"
                            >
                              {item.name}
                            </div>
                          )}
            ...
            <Example title="Two Sidebar Layout" description="Navigation sidebar + content sidebar + main content (Audio Library pattern)">
              <div className="h-64 bg-black/20 rounded-[8px] p-2 flex gap-2">
                ...
                <div className="w-48 bg-[#191919] rounded-[4px] p-2 border-r border-white/10">
                  <div className="text-[11px] text-white/60 mb-2 font-medium">Playlists</div>
                ...
                <div className="flex-1 bg-[#191919] rounded-[4px] p-2">
                  <div className="text-[11px] text-white/60 mb-2 font-medium">Main Content</div>
                  <div className="space-y-1">
                    <div className="h-6 bg-white/5 rounded-[4px]"></div>
                    <div className="h-6 bg-white/5 rounded-[4px]"></div>
                    <div className="h-6 bg-white/5 rounded-[4px]"></div>
          ...
          <Section title="Animations" id="animations">
            <div className="space-y-12">
              ...
              <div id="playing-track" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Playing Track Animation</h3>
                ...
                <Example title="Visual Effects Breakdown">
                  <div className="space-y-3 text-[13px]">
                    <div className="bg-purple-500/10 border border-purple-500/20 rounded-[6px] p-3">
                      ...
                      <p className="text-white/60 text-[12px]">Animated horizontal gradient sweep with multiple purple tones (5s duration, 400ms fade-in)</p>
                    </div>
                    <div className="bg-purple-500/10 border border-purple-500/20 rounded-[6px] p-3">
                      <p className="text-white font-medium mb-1">2. Left Edge Glow</p>
                      <p className="text-white/60 text-[12px]">3px vertical purple gradient bar that pulses (2.5s intervals)</p>
                    </div>
                    <div className="bg-purple-500/10 border border-purple-500/20 rounded-[6px] p-3">
                      <p className="text-white font-medium mb-1">3. Audio Visualizer Bars</p>
                      <p className="text-white/60 text-[12px]">Three animated bars with staggered timing (0.6s, 0.8s, 0.7s) that swap with pause button on hover</p>
                    </div>
                  </div>
                </Example>
              </div>
              ...
              <div id="audio-player" className="scroll-mt-24">
                <h3 className="text-[18px] font-medium text-white mb-4">Audio Player Footer</h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-white font-medium text-[14px]">DO:</p>
                        <ul className="space-y-1.5 mt-2 text-white/60 text-[13px]">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-white font-medium text-[14px]">DON&apos;T:</p>
                        <ul className="space-y-1.5 mt-2 text-white/60 text-[13px]">
              ...
              <Example title="Implemented Elements">
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-[8px] p-4">
                    ...
                    <p className="text-white/60 mt-2 text-[13px]">Random phrases during file uploads that reference D&D mechanics and flavor</p>
                  </div>

                  <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-[8px] p-4">
                    <p className="text-white font-medium mb-2">Playing Track Visualizer</p>
                    <p className="text-white/60 text-[13px]">Animated purple gradient with pulsing visualizer bars. Makes the currently playing track feel alive and magical, like a spell being cast.</p>
                  </div>

                  <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-[8px] p-4">
                    <p className="text-white font-medium mb-2">Arcane Drop Zone</p>
                    <p className="text-white/60 text-[13px]">Pulsing purple border and background animation when dragging files. Makes file uploads feel like summoning items into your magical library.</p>
                  </div>
                </div>
              </Example>

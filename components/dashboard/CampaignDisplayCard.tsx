...
export function CampaignDisplayCard({ campaign, onEdit }: CampaignCardProps) {
  ...
  return (
    <article className="bg-white/[0.02] hover:bg-white/[0.05] transition-all rounded-[8px]">
      <Link
      ...
      >
        <div
          className="w-14 h-14 rounded-[8px] flex-shrink-0 shadow-lg"
          style={{
        ...
        {onEdit && (
          <button
            ...
            className="w-8 h-8 rounded-[8px] hover:bg-white/10 flex items-center justify-center transition-colors opacity-0 group-hover:opacity-100"
